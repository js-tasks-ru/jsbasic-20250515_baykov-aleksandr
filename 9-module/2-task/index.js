...
export default class Main {
  ...
  async render() {
    ...
    document
      ...
      .append(new RibbonMenu(categories)._elem);
    document
      .querySelector("div[data-slider-holder]")
      .append(new StepSlider({ steps: 5, value: 3 })._elem);
    ...
    async function productGridRender() {
      try {
        ...
        productGrid.append(new ProductsGrid(data).elem);
      } catch (e) {
